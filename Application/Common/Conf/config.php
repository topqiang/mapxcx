...
return  array(
    ...
    'MODULE_ALLOW_LIST'     => array('Home','Admin','Api','Teach'), //分组
    'DEFAULT_GROUP'         => 'Home', //默认分组
    /* Cookie设置 */
    'COOKIE_EXPIRE'         => 0, // Coodie有效期
    'COOKIE_DOMAIN'         => '', // Cookie有效域名
    'COOKIE_PATH'           => '/', // Cookie路径
    'COOKIE_PREFIX'         => 'NONGYE', // Cookie前缀 避免冲突

    /* 数据库设置 */
    'DB_TYPE'               => 'mysql', // 数据库类型
    'DB_HOST'               => 'localhost', // 服务器地址
    'DB_USER'               => 'root', // 用户名
    'DB_PWD'                => 'shebei2017', // 密码
    'DB_NAME'               => 'jians', // 数据库名
    'DB_PORT'               => '3306', // 端口
    ...
    'SESSION_PREFIX'        => 'NONGYE', // session 前缀
    ...
    'TMPL_PARSE_STRING'     => array(
        ...
        '__WEBUPLOADS__'     => __ROOT__.'/Uploads',
        '__CONTROLLER__'     =>CONTROLLER_NAME,
    ),
    ...
    'LOAD_EXT_FILE'         => 'Upload,Zip,Files,Filedown',
